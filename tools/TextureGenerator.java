...
public class TextureGenerator {
    ...
    static Map<String, int[]> defaultPasserineDimensions() {
        ...
        dims.put(L_UPPER_WING,   new int[]{1, 4, 4});
        dims.put(L_SCAPULARS,    new int[]{1, 3, 3});
        dims.put(L_FOREARM,      new int[]{1, 3, 3});
        dims.put(L_SECONDARIES,  new int[]{1, 3, 3});
        dims.put(L_HAND,         new int[]{1, 3, 2});
        dims.put(L_PRIMARIES,    new int[]{1, 3, 2});
        dims.put(R_UPPER_WING,   new int[]{1, 4, 4});
        dims.put(R_SCAPULARS,    new int[]{1, 3, 3});
        dims.put(R_FOREARM,      new int[]{1, 3, 3});
        dims.put(R_SECONDARIES,  new int[]{1, 3, 3});
        dims.put(R_HAND,         new int[]{1, 3, 2});
        dims.put(R_PRIMARIES,    new int[]{1, 3, 2});
        dims.put(TAIL_BASE,      new int[]{2, 1, 2});
        dims.put(TAIL_FAN,       new int[]{2, 1, 3});
    ...
    static Map<String, int[]> barnOwlDimensions() {
        ...
        dims.put(L_UPPER_WING,   new int[]{1, 8, 6});
        dims.put(L_SCAPULARS,    new int[]{1, 6, 5});
        dims.put(L_FOREARM,      new int[]{1, 7, 5});
        dims.put(L_SECONDARIES,  new int[]{1, 6, 5});
        dims.put(L_HAND,         new int[]{1, 6, 4});
        dims.put(L_PRIMARIES,    new int[]{1, 5, 4});
        dims.put(R_UPPER_WING,   new int[]{1, 8, 6});
        dims.put(R_SCAPULARS,    new int[]{1, 6, 5});
        dims.put(R_FOREARM,      new int[]{1, 7, 5});
        dims.put(R_SECONDARIES,  new int[]{1, 6, 5});
        dims.put(R_HAND,         new int[]{1, 6, 4});
        dims.put(R_PRIMARIES,    new int[]{1, 5, 4});
        dims.put(TAIL_BASE,      new int[]{3, 1, 3});
        dims.put(TAIL_FAN,       new int[]{4, 1, 3});
        dims.put(L_THIGH,        new int[]{1, 3, 1});
        dims.put(L_SHIN,         new int[]{1, 4, 1});
        dims.put(L_TARSUS,       new int[]{1, 3, 1});
        dims.put(L_FOOT,         new int[]{2, 1, 2});
        dims.put(R_THIGH,        new int[]{1, 3, 1});
        dims.put(R_SHIN,         new int[]{1, 4, 1});
        dims.put(R_TARSUS,       new int[]{1, 3, 1});
        dims.put(R_FOOT,         new int[]{2, 1, 2});
        return dims;
    }
    ...
    static Map<String, int[]> peregrineDimensions() {
        ...
        dims.put(UPPER_BEAK,     new int[]{1, 1, 2});
        dims.put(LOWER_BEAK,     new int[]{1, 1, 2});
        dims.put(L_UPPER_WING,   new int[]{1, 6, 5});
        dims.put(L_SCAPULARS,    new int[]{1, 5, 4});
        dims.put(L_FOREARM,      new int[]{1, 6, 4});
        dims.put(L_SECONDARIES,  new int[]{1, 5, 4});
        dims.put(L_HAND,         new int[]{1, 5, 3});
        dims.put(L_PRIMARIES,    new int[]{1, 5, 3});
        dims.put(R_UPPER_WING,   new int[]{1, 6, 5});
        dims.put(R_SCAPULARS,    new int[]{1, 5, 4});
        dims.put(R_FOREARM,      new int[]{1, 6, 4});
        dims.put(R_SECONDARIES,  new int[]{1, 5, 4});
        dims.put(R_HAND,         new int[]{1, 5, 3});
        dims.put(R_PRIMARIES,    new int[]{1, 5, 3});
        dims.put(TAIL_BASE,      new int[]{3, 1, 3});
    ...
    static Map<String, int[]> mallardDimensions() {
        ...
        dims.put(L_UPPER_WING,   new int[]{1, 6, 5});
        dims.put(L_SCAPULARS,    new int[]{1, 5, 4});
        dims.put(L_FOREARM,      new int[]{1, 5, 4});
        dims.put(L_SECONDARIES,  new int[]{1, 4, 4});
        dims.put(L_HAND,         new int[]{1, 4, 3});
        dims.put(L_PRIMARIES,    new int[]{1, 3, 3});
        dims.put(R_UPPER_WING,   new int[]{1, 6, 5});
        dims.put(R_SCAPULARS,    new int[]{1, 5, 4});
        dims.put(R_FOREARM,      new int[]{1, 5, 4});
        dims.put(R_SECONDARIES,  new int[]{1, 4, 4});
        dims.put(R_HAND,         new int[]{1, 4, 3});
        dims.put(R_PRIMARIES,    new int[]{1, 3, 3});
        dims.put(TAIL_BASE,      new int[]{3, 1, 3});
        dims.put(TAIL_FAN,       new int[]{5, 1, 4});
        dims.put(L_THIGH,        new int[]{1, 3, 1});
        dims.put(L_SHIN,         new int[]{1, 3, 1});
        dims.put(L_TARSUS,       new int[]{1, 3, 1});
